...
var L = (f, u, p) =>
    u in f
      ? B(f, u, { enumerable: !0, configurable: !0, writable: !0, value: p })
      : (f[u] = p),
  x = (f, u) => {
    for (var p in u || (u = {})) W.call(u, p) && L(f, p, u[p]);
    if (V) for (var p of V(u)) Y.call(u, p) && L(f, p, u[p]);
    return f;
  };
var d = (f, u, p) => (L(f, typeof u != "symbol" ? u + "" : u, p), p);
(function (f, u) {
  ...
  (function (o) {
    (o.Required = "required"),
      ...
      (o.Password = "password"),
      (o.Number = "number"),
      (o.MaxNumber = "maxNumber"),
      (o.MinNumber = "minNumber"),
      (o.StrongPassword = "strongPassword"),
      (o.CustomRegexp = "customRegexp");
  })(h || (h = {}));
  var g;
  (function (o) {
    o.Required = "required";
  ...
  class Z {
      ...
      d(this, "formSubmitHandler", (e) => {
        e.preventDefault(),
          ...
          this.validate().then(() => {
            var r, t;
            this.isValid
              ? (r = this.onSuccessCallback) == null || r.call(this, e)
              : (t = this.onFailCallback) == null || t.call(this, this.fields),
    ...
    initialize(e, r, t) {
      ...
      if (
        ((this.globalConfig = x(x({}, S), r)),
        t && (this.dictLocale = t),
        this.isTooltip())
      ) {
        const i = document.createElement("style");
        (i.textContent = X),
          (this.customStyleTags[C.Label] = document.head.appendChild(i)),
    ...
    getLocalisedString(e) {
      ...
      return !this.currentLocale || !this.dictLocale.length
        ? e
        : ((t = this.dictLocale.find((i) => i.key === e)) == null
            ? void 0
    ...
    setFieldInvalid(e, r) {
      (this.fields[e].isValid = !1),
        (this.fields[e].errorMessage = this.getFieldErrorMessage(r));
    }
    setGroupInvalid(e, r) {
      (this.groupFields[e].isValid = !1),
        (this.groupFields[e].errorMessage = this.getGroupErrorMessage(r));
    }
    setGroupValid(e) {
    ...
    validateGroupRule(e, r, t, i) {
      switch (i.rule) {
        case g.Required:
          (r === "radio" || r === "checkbox") &&
            (t.every((s) => !s.checked)
              ? this.setGroupInvalid(e, i)
              : this.setGroupValid(e));
      }
    }
    validateFieldRule(e, r, t, i = !1) {
      const s = t.value,
      ...
      switch (t.rule) {
        ...
        case h.MaxLength: {
          if (!s) {
            console.error(
              `Value for ${t.rule} rule for [${e}] field is not defined. The field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            return;
          }
          if (typeof s != "number") {
            console.error(
              `Value for ${t.rule} rule for [${e}] should be a number. The field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            return;
          }
        ...
        case h.MaxNumber: {
          ...
          if (typeof s != "number") {
            console.error(
              `Value for ${t.rule} rule for [${e}] field should be a number. The field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            return;
          }
        ...
        case h.MinNumber: {
          ...
          const l = +a;
          (Number.isNaN(l) || D(l, s)) && this.setFieldInvalid(e, t);
          break;
        }
        case h.CustomRegexp: {
          if (!s) {
            console.error(
              `Value for ${t.rule} rule for [${e}] field is not defined. This field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            return;
          }
          ...
          try {
            ...
            console.error(
              `Value for ${t.rule} rule for [${e}] should be a valid regexp. This field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            break;
          }
          l.test(String(a)) || this.setFieldInvalid(e, t);
          break;
        }
        default: {
          if (!t.validator) {
            console.error(
              `Validator for custom rule for [${e}] field is not defined. This field will be always invalid.`
            ),
              this.setFieldInvalid(e, t);
            return;
          }
          ...
          const l = t.validator(a, this.fields);
          if (
            (typeof l != "boolean" &&
              typeof l != "function" &&
              console.error(
            ...
            return c
              .then((m) => {
                m || this.setFieldInvalid(e, t);
              })
              .catch(() => {
                this.setFieldInvalid(e, t);
              });
          }
          l || this.setFieldInvalid(e, t);
        }
      }
    }
    validateField(e, r, t = !1) {
      r.isValid = !0;
      const i = [];
      return (
        [...r.rules].reverse().forEach((s) => {
          const a = this.validateFieldRule(e, r.elem, s, t);
          v(a) && i.push(a);
        }),
    ...
    validateGroup(e, r) {
      ...
      return (
        [...r.rules].reverse().forEach((i) => {
          const s = this.validateGroupRule(e, r.type, r.elems, i);
          v(s) && t.push(s);
        }),
    ...
    validate() {
      return new Promise((e) => {
        ...
        Object.keys(this.fields).forEach((t) => {
          const i = this.fields[t],
            s = this.validateField(t, i);
          v(s) && r.push(s);
        }),
          Object.keys(this.groupFields).forEach((t) => {
            const i = this.groupFields[t],
              s = this.validateGroup(t, i);
            v(s) && r.push(s);
          }),
          r.length
    ...
    addListener(e, r, t) {
      r.addEventListener(e, t),
        this.eventListeners.push({ type: e, elem: r, func: t });
    }
    ...
    addField(e, r, t) {
      ...
      return (
        r.forEach((s) => {
          if (!("rule" in s || "validator" in s))
            throw Error(
              `Rules argument for the field [${e}] must contain at least one rule or validator property.`
            );
          if (!s.validator && (!s.rule || !Object.values(h).includes(s.rule)))
            throw Error(
              `Rule should be one of these types: ${Object.values(h).join(
                ", "
              )}. Provided value: ${s.rule}`
            );
        }),
        (this.fields[e] = { elem: i, rules: r, isValid: void 0, config: t }),
        this.setListeners(i),
    ...
    removeField(e) {
      ...
      return this.fields[e]
        ? (this.destroy(), delete this.fields[e], this.refresh(), this)
        : (console.error("Field not found. Check the field selector."), this);
    }
    addRequiredGroup(e, r, t) {
      if (typeof e != "string")
        throw Error(
      ...
      const s = i.querySelectorAll("input"),
        a = Array.from(s).every((c) => c.type === "radio"),
        l = Array.from(s).every((c) => c.type === "checkbox");
      if (!a && !l)
        throw Error(
      ...
      return (
        (this.groupFields[e] = {
          rules: [{ rule: g.Required, errorMessage: r }],
          groupElem: i,
          elems: Array.from(s),
    ...
    setListeners(e) {
      const r = this.getListenerType(e.type);
      this.removeListener(r, e, this.handlerChange),
        this.addListener(r, e, this.handlerChange);
    }
    clearErrors() {
      var e, r, t;
      this.errorLabels.forEach((i) => i.remove());
      for (const i in this.fields) {
        const s = this.fields[i],
          a =
            ((e = s.config) == null ? void 0 : e.errorFieldStyle) ||
      ...
      for (const i in this.groupFields) {
        const s = this.groupFields[i],
          a =
            ((t = s.config) == null ? void 0 : t.errorFieldStyle) ||
            this.globalConfig.errorFieldStyle;
        Object.keys(a).forEach((l) => {
          s.elems.forEach((c) => {
            var m;
    ...
    lockForm() {
      ...
      for (let r = 0, t = e.length; r < t; ++r)
        e[r].setAttribute("disabled", "disabled"),
          (e[r].style.pointerEvents = "none"),
          (e[r].style.webkitFilter = "grayscale(100%)"),
          (e[r].style.filter = "grayscale(100%)");
    }
    unlockForm() {
      const e = this.form.querySelectorAll("input, textarea, button, select");
      for (let r = 0, t = e.length; r < t; ++r)
        e[r].removeAttribute("disabled"),
          (e[r].style.pointerEvents = ""),
          (e[r].style.webkitFilter = ""),
          (e[r].style.filter = "");
    }
    renderTooltip(e, r, t) {
      var y;
      const {
        ...
        m =
          t || ((y = this.globalConfig.tooltip) == null ? void 0 : y.position);
      switch (m) {
        case "left": {
          (r.style.top = `${i + l / 2 - c.height / 2}px`),
            (r.style.left = `${s - c.width - E}px`);
          break;
        }
        case "top": {
          (r.style.top = `${i - c.height - E}px`),
            (r.style.left = `${s + a / 2 - c.width / 2}px`);
          break;
        }
        case "right": {
          (r.style.top = `${i + l / 2 - c.height / 2}px`),
            (r.style.left = `${s + a + E}px`);
          break;
        }
        case "bottom": {
          (r.style.top = `${i + l + E}px`),
            (r.style.left = `${s + a / 2 - c.width / 2}px`);
          break;
        }
      }
      return (
        (r.dataset.direction = m),
        {
          refresh: () => {
            this.renderTooltip(e, r, t);
          },
        }
      );
    }
    createErrorLabelElem(e, r, t) {
      ...
      const s = this.isTooltip()
        ? t == null
          ? void 0
          : t.errorLabelStyle
        : (t == null ? void 0 : t.errorLabelStyle) ||
          this.globalConfig.errorLabelStyle;
      return (
        Object.assign(i.style, s),
        i.classList.add(
          (t == null ? void 0 : t.errorLabelCssClass) ||
    ...
    renderErrors() {
      ...
      if (!!this.isSubmitted) {
        ...
        for (const F in this.groupFields) {
          const n = this.groupFields[F];
          ...
          (this.isValid = !1),
            n.elems.forEach((w) => {
              ...
              Object.assign(
                w.style,
                (($ = n.config) == null ? void 0 : $.errorFieldStyle) ||
                  this.globalConfig.errorFieldStyle
              ),
                w.classList.add(
                  ((I = n.config) == null ? void 0 : I.errorFieldCssClass) ||
                    this.globalConfig.errorFieldCssClass
                );
            });
          const b = this.createErrorLabelElem(F, n.errorMessage, n.config);
          n.groupElem.appendChild(b),
            this.isTooltip() &&
              this.tooltips.push(
                this.renderTooltip(
                  n.groupElem,
                  b,
                  (r = (e = n.config) == null ? void 0 : e.tooltip) == null
                    ? void 0
                    : r.position
                )
              );
        ...
        for (const F in this.fields) {
          ...
          (this.isValid = !1),
            n.elem.classList.add(
              ((t = n.config) == null ? void 0 : t.errorFieldCssClass) ||
                this.globalConfig.errorFieldCssClass
            );
          const b = this.createErrorLabelElem(F, n.errorMessage, n.config);
          if (n.elem.type === "checkbox" || n.elem.type === "radio") {
            const w = document.querySelector(
              `label[for="${n.elem.getAttribute("id")}"]`
            );
            ((s = (i = n.elem.parentElement) == null ? void 0 : i.tagName) ==
            null
              ? void 0
              : s.toLowerCase()) === "label"
              ? (l =
                  (a = n.elem.parentElement) == null
                    ? void 0
                    : a.parentElement) == null || l.appendChild(b)
              : w
              ? (c = w.parentElement) == null || c.appendChild(b)
              : (m = n.elem.parentElement) == null || m.appendChild(b);
          ...
          this.isTooltip() &&
            this.tooltips.push(
              this.renderTooltip(
                n.elem,
                b,
                (T = (y = n.config) == null ? void 0 : y.tooltip) == null
                  ? void 0
                  : T.position
              )
            );
